...
void intercala(ListaFilmes *lst, ListaFilmes *p, ListaFilmes *q, Criterio criterio);

void quickSortFilmes(ListaFilmes *lst, Criterio criterio);

int separa(int p, int r, ListaFilmes *lst, Criterio criterio);

void qSort(int p, int r, ListaFilmes *lst, Criterio criterio);

void percorre(Filme *flm, int i);
